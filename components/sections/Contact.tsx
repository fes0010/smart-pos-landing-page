        ...
        <div className="contact-info space-y-8">
          ...
          <Card className="bg-[#25D366]/10 border-[#25D366]/30">
            <CardContent className="p-6 text-center">
              ...
              <h4 className="font-bold text-gray-900 text-lg mb-2">Prefer WhatsApp?</h4>
              <p className="text-gray-600 text-sm mb-4">Get instant answers to your questions</p>
              <a
                href="https://wa.me/254741047776?text=Hi%2C%20I%27m%20interested%20in%20Smart%20POS%20and%20would%20like%20to%20chat"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-[#25D366] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#20bd5a] transition-colors w-full justify-center"
              >
