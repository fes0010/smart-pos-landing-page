      ...
      <Container className="relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center py-20">
          ...
          <div className="space-y-8">
            ...
            <div ref={ctaRef} className="space-y-4 relative z-20">
              ...
              {/* Demo Credentials */}
              <div className="inline-flex flex-col sm:flex-row gap-3 items-start sm:items-center bg-white/10 backdrop-blur-sm rounded-lg px-4 py-3 text-sm">
                <span className="text-gray-300">Demo login:</span>
                <div className="flex flex-wrap gap-3">
                  <span className="text-white font-mono bg-white/10 px-2 py-1 rounded">demo@user.com</span>
                  <span className="text-white font-mono bg-white/10 px-2 py-1 rounded">demo1234</span>
                </div>
              </div>
            </div>
